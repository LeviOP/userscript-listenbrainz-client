...
export interface VoiceSearchDialogRenderer {
    placeholderHeader:              Text;
    promptHeader:                   Text;
    exampleQuery1:                  Text;
    exampleQuery2:                  Text;
    promptMicrophoneLabel:          Text;
    loadingHeader:                  Text;
    connectionErrorHeader:          Text;
    connectionErrorMicrophoneLabel: Text;
    permissionsHeader:              Text;
    permissionsSubtext:             Text;
    disabledHeader:                 Text;
    disabledSubtext:                Text;
    microphoneButtonAriaLabel:      Text;
    exitButton:                     VoiceSearchButtonClass;
    trackingParams:                 string;
    microphoneOffPromptHeader:      Text;
}
...
export interface ClientMessages {
    ...
    unableToReconnectMessage: Text;
    fatalError:               Text;
    reconnectedMessage:       Text;
    genericError:             Text;
}
...
export interface WatchNextDataHeader {
